...
export default function Tv() {
  ...
  function next(){
    ...
    getData('person',setMoviesData,x++)
    }
  ...
  function previous(){
    ...
    if(z>3){
    testo3.innerText= z-=3
    getData('person',setMoviesData,z--)
    }
 ...
 async function getData(category,setData,page){
  ...
  useEffect(()=>{
   getData('person',setMoviesData,1);
  ...
  return (
    ...
    <div className='d-flex justify-content-center'>
      ...
      <div onClick={(e)=>{
        getData('person',setMoviesData,e.target.innerText)
